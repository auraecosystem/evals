...
Copy this script ð. Save it as `test_loadtest_router.py` AND run it with `python3 test_loadtest_router.py`
...
router_settings:
  ...
  redis_host: os.environ/REDIS_HOST ## ð IMPORTANT! Setup the proxy w/ redis
...
Copy this script ð. Save it as `test_loadtest_proxy.py` AND run it with `python3 test_loadtest_proxy.py`
